		...
		(function resolveAttachmentUrl(i) {
			if (v.delta.attachments && (i == v.delta.attachments.length)) {
				...
				try {
					...
					if (v.delta.attachments && v.delta.attachments.reply_data) {
						const replyData = v.delta.attachments.reply_data;
						fmtMsg.messageReply = {
							threadID: fmtMsg.threadID,
							messageID: replyData.message_id,
							senderID: replyData.sender_id || replyData.message_sender,
							attachments: replyData.attachment || [],
							body: replyData.message || "",
							timestamp: replyData.timestamp,
							isGroup: fmtMsg.isGroup,
							participantIDs: replyData.participant_ids || []
						};
					}
