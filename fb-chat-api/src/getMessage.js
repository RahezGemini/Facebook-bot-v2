...
function formatMessage(threadID, data) {
  switch (data.__typename) {
    ...
    case "UserMessage":
      ...
      if (data.replied_to_message) {
        msg.messageReply = {
          threadID: threadID,
          messageID: data.replied_to_message.message_id,
          senderID: data.replied_to_message.message_sender.id,
          body: data.replied_to_message.message.text || "",
          attachments: (data.replied_to_message.blob_attachments || []).map(
            (att) => {
              try {
          ...
          timestamp: data.replied_to_message.timestamp_precise,
        };
      }
